...
The audit method, report framework and operator workflow have been prepared. Each real engagement still requires explicit agreement on scope, permissi…14222 tokens truncated…json`
- `.mcp.json`
- `package.json`
